...
<!-- Mirrored from www.display-inline.fr/demo/developr/template/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Dec 2014 03:35:14 GMT -->
<head>
	<meta charset="utf-8">
	...
	<!-- Additional styles -->
	<link rel="stylesheet" href="<?php echo config_item('assets'); ?>css/styles/agenda3860.css?v=1">
	<link rel="stylesheet" href="<?php echo config_item('assets'); ?>css/styles/dashboard3860.css?v=1">
	<link rel="stylesheet" href="<?php echo config_item('assets'); ?>css/styles/form3860.css?v=1">
	<link rel="stylesheet" href="<?php echo config_item('assets'); ?>css/styles/modal3860.css?v=1">
	<link rel="stylesheet" href="<?php echo config_item('assets'); ?>css/styles/progress-slider3860.css?v=1">
...
<body class="clearfix with-menu with-shortcuts">
	...
	<!--[if lt IE 7]>
		<p class="message red-gradient simpler">Your browser is <em>ancient!</em> <a href="http://browsehappy.com/">Upgrade to a different browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">install Google Chrome Frame</a> to experience this site.</p><![endif]-->
	<!-- Title bar -->
	...
	<script src="<?php echo config_item('assets'); ?>js/developr.modal.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.navigable.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.notify.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.scroll.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.progress-slider.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.tooltip.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.confirm.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.agenda.js"></script>
	<script src="<?php echo config_item('assets'); ?>js/developr.tabs.js"></script>		<!-- Must be loaded last -->
